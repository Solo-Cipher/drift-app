...
class TripGenerator {
  ...
  static TripData generate({
    ...
    return TripData(
      ...
      subtitle: '${config.originAirport} → ${config.iataCode.isNotEmpty ? config.iataCode : config.primaryCity}',
      startDate: startStr,
      endDate: endStr,
      totalDays: totalDays,
  ...
  static List<TripDay> _vietnamDays(DateTime startDate, int totalDays) {
    ...
    final List<Map<String, dynamic>> templates = [
      {'location': hanoi.displayName, 'country': 'vietnam', 'title': 'Arrival in Hanoi', 'description': 'Fly to Hanoi. Settle into the Old Quarter and explore the vibrant street life.', 'activities': ['Hoan Kiem Lake evening walk', 'Old Quarter exploration', 'Pho dinner at local spot'], 'arrivalTransport': TransportMode.flight, 'transportDuration': '14h total', 'transportCost': '200', 'accommodationCost': '25', 'foodCost': '8', 'icon': Icons.flight_land, 'color': const Color(0xFF6C63FF), 'isTravelDay': true, 'lat': hanoi.coordinates.lat, 'lng': hanoi.coordinates.lng},
  ...
  static List<TripDay> _indonesiaDays(DateTime startDate, int totalDays) {
    ...
    final List<Map<String, dynamic>> templates = [
      {'location': jakarta.displayName, 'country': 'indonesia', 'title': 'Arrival in Jakarta', 'description': 'Fly to Jakarta. Settle in and explore the capital.', 'activities': ['Monas (National Monument)', 'Kota Tua Old Town', 'Street food in Glodok'], 'arrivalTransport': TransportMode.flight, 'transportDuration': '12h total', 'transportCost': '200', 'accommodationCost': '24', 'foodCost': '8', 'icon': Icons.flight_land, 'color': const Color(0xFF6C63FF), 'isTravelDay': true, 'lat': jakarta.coordinates.lat, 'lng': jakarta.coordinates.lng},
      ...
      {'location': bali.displayName, 'country': 'indonesia', 'title': 'Departure Day', 'description': 'Last morning in Bali. Fly home.', 'activities': ['Beach morning swim', 'Souvenir hunt', 'Airport transfer'], 'departureTransport': TransportMode.flight, 'transportDuration': '12h total', 'transportCost': '0', 'accommodationCost': '0', 'foodCost': '8', 'icon': Icons.flight_takeoff, 'color': const Color(0xFF6C63FF), 'isTravelDay': true, 'lat': bali.coordinates.lat, 'lng': bali.coordinates.lng},
    ];
    return _buildDaysFromTemplates(templates, startDate, totalDays);
  }
  ...
  static List<TripDay> _scotlandDays(DateTime startDate, int totalDays) {
    ...
    final List<Map<String, dynamic>> templates = [
      ...
      {'location': edinburgh.displayName, 'country': 'scotland', 'title': 'Departure Day', 'description': 'Last morning in Scotland. Fly home.', 'activities': ['Morning walk at Holyrood', 'Last haggis lunch', 'Airport transfer'], 'departureTransport': TransportMode.flight, 'transportDuration': '12h total', 'transportCost': '0', 'accommodationCost': '0', 'foodCost': '10', 'icon': Icons.flight_takeoff, 'color': const Color(0xFF6C63FF), 'isTravelDay': true, 'lat': edinburgh.coordinates.lat, 'lng': edinburgh.coordinates.lng},
    ];
    return _buildDaysFromTemplates(templates, startDate, totalDays);
  }
  ...
  static List<TripDay> _mauritiusDays(DateTime startDate, int totalDays) {
    ...
    final List<Map<String, dynamic>> templates = [
      {'location': portLouis.displayName, 'country': 'mauritius', 'title': 'Arrival in Mauritius', 'description': 'Fly to Mauritius. Settle into your beach resort.', 'activities': ['Beach walk', 'Sunset cocktails', 'Welcome dinner at resort'], 'arrivalTransport': TransportMode.flight, 'transportDuration': '8h total', 'transportCost': '250', 'accommodationCost': '35', 'foodCost': '10', 'icon': Icons.flight_land, 'color': const Color(0xFF6C63FF), 'isTravelDay': true, 'lat': portLouis.coordinates.lat, 'lng': portLouis.coordinates.lng},
      ...
      {'location': portLouis.displayName, 'country': 'mauritius', 'title': 'Departure Day', 'description': 'Last morning in Mauritius. Fly home.', 'activities': ['Beach morning walk', 'Last-minute souvenirs', 'Airport transfer'], 'departureTransport': TransportMode.flight, 'transportDuration': '8h total', 'transportCost': '0', 'accommodationCost': '0', 'foodCost': '8', 'icon': Icons.flight_takeoff, 'color': const Color(0xFF6C63FF), 'isTravelDay': true, 'lat': portLouis.coordinates.lat, 'lng': portLouis.coordinates.lng},
    ];
    return _buildDaysFromTemplates(templates, startDate, totalDays);
  }
  ...
  static List<TripDay> _thailandDays(DateTime startDate, int totalDays) {
    ...
    final List<Map<String, dynamic>> templates = [
      ...
      {'location': bangkok.displayName, 'country': 'thailand', 'title': 'Departure Day', 'description': 'Last morning in Thailand. Fly home.', 'activities': ['Morning market walk', 'Last pad thai', 'Airport transfer'], 'departureTransport': TransportMode.flight, 'transportDuration': '10h total', 'transportCost': '0', 'accommodationCost': '0', 'foodCost': '8', 'icon': Icons.flight_takeoff, 'color': const Color(0xFF6C63FF), 'isTravelDay': true, 'lat': bangkok.coordinates.lat, 'lng': bangkok.coordinates.lng},
    ];
    return _buildDaysFromTemplates(templates, startDate, totalDays);
  }
  ...
  static List<TripDay> _japanDays(DateTime startDate, int totalDays) {
    ...
    final List<Map<String, dynamic>> templates = [
      ...
      {'location': tokyo.displayName, 'country': 'japan', 'title': 'Departure Day', 'description': 'Last morning in Japan. Fly home.', 'activities': ['Tsukiji breakfast', 'Last-minute souvenirs', 'Airport transfer'], 'departureTransport': TransportMode.flight, 'transportDuration': '14h total', 'transportCost': '0', 'accommodationCost': '0', 'foodCost': '10', 'icon': Icons.flight_takeoff, 'color': const Color(0xFF6C63FF), 'isTravelDay': true, 'lat': tokyo.coordinates.lat, 'lng': tokyo.coordinates.lng},
    ];
    return _buildDaysFromTemplates(templates, startDate, totalDays);
  }
  ...
  static List<TripDay> _turkeyDays(DateTime startDate, int totalDays) {
    ...
    final List<Map<String, dynamic>> templates = [
      ...
      {'location': istanbul.displayName, 'country': 'turkey', 'title': 'Departure Day', 'description': 'Last morning in Turkey. Fly home.', 'activities': ['Last Turkish breakfast', 'Souvenir shopping', 'Airport transfer'], 'departureTransport': TransportMode.flight, 'transportDuration': '8h total', 'transportCost': '0', 'accommodationCost': '0', 'foodCost': '8', 'icon': Icons.flight_takeoff, 'color': const Color(0xFF6C63FF), 'isTravelDay': true, 'lat': istanbul.coordinates.lat, 'lng': istanbul.coordinates.lng},
    ];
    return _buildDaysFromTemplates(templates, startDate, totalDays);
  }
  ...
  static List<TripDay> _moroccoDays(DateTime startDate, int totalDays) {
    ...
    final List<Map<String, dynamic>> templates = [
      {'location': casablanca.displayName, 'country': 'morocco', 'title': 'Arrival in Casablanca', 'description': 'Fly to Casablanca. Visit the Hassan II Mosque.', 'activities': ['Hassan II Mosque', 'Corniche waterfront', 'Moroccan tea ceremony'], 'arrivalTransport': TransportMode.flight, 'transportDuration': '8h total', 'transportCost': '200', 'accommodationCost': '22', 'foodCost': '8', 'icon': Icons.flight_land, 'color': const Color(0xFF6C63FF), 'isTravelDay': true, 'lat': casablanca.coordinates.lat, 'lng': casablanca.coordinates.lng},
      ...
      {'location': casablanca.displayName, 'country': 'morocco', 'title': 'Departure Day', 'description': 'Last morning in Morocco. Fly home.', 'activities': ['Last mint tea', 'Souvenir shopping', 'Airport transfer'], 'departureTransport': TransportMode.flight, 'transportDuration': '8h total', 'transportCost': '0', 'accommodationCost': '0', 'foodCost': '8', 'icon': Icons.flight_takeoff, 'color': const Color(0xFF6C63FF), 'isTravelDay': true, 'lat': casablanca.coordinates.lat, 'lng': casablanca.coordinates.lng},
    ];
    return _buildDaysFromTemplates(templates, startDate, totalDays);
  }
